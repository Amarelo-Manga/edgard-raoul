    ...
    <header	id="top" class="container-fluid bg-roxo"> 
        ...
        <div class="container">
			<nav class="navbar navbar-expand-lg navbar-light bg-roxo">
                 <a class="navbar-brand" style="z-index: 100;" href="http://edgardraoulvoice.com.br/"><img src="<?php echo get_template_directory_uri()?>/assets/img/logo_edgard_raoul.png" alt="logo Edgard Raoul" class="logo-mobile" /></a>
